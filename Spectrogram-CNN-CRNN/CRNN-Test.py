...
# -*- coding: utf-8 -*-
"""
Created on Tue May 14 15:16:48 2019
...
def main():
    ...
    for sp_test in range(10):
        ...
        (x_train, y_train, y_train_raw,
         ...
         x_test, y_test, y_test_raw) = utils.Preprocess(sp_test, emotionsTest,
                                                        dataDf, tMax, fMax)
        model = load_model("models/CRNN/{}.h5".format(sp_test))
    ...
    imageName = "results/CRNN/Test_{}_CRNN_V.png".format(dataname)
    title = "wa={}, ua={}".format(waV, uaV)
    utils.plot_wauacm(title, cmpV, emotionsTest, imageName)
    imageName = "results/CRNN/Test_{}_CRNN_T.png".format(dataname)
